...
const repairTools = new Set(["activity_update", "worktree_read", "worktree_write", "worktree_patch", "worktree_command", "git_diff", "git_status", "repository_diagnostics", "repository_file_graph", "repository_definition", "repository_references", "repository_symbol_info", "browser_open", "browser_click", "browser_dom", "browser_console", "browser_network", "browser_responsive", "browser_screenshot", "browser_accessibility", "browser_close", "browser_server_start"]);
